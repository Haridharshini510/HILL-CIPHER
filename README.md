...
STEP-2: Split the plain text into groups of length three. STEP-3: Arrange the keyword in a 3*3 
matrix. 
...
```
# OUTPUT: 
<img width="898" height="375" alt="image" src="https://github.com/user-attachments/assets/faf7920c-1932-4e30-aa41-9c0882a31ebc" />
